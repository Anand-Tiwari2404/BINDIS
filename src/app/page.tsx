...
export default function Home() {
  ...
  {[
    ...
    <div key={index} className={`group bg-gradient-to-b ${gradient} p-8 rounded-xl shadow-lg hover:shadow-2xl transition-shadow duration-300`}>
      {icon}
...
<section className="mb-12">
  ...
  <div className="grid grid-cols-2 md:grid-cols-4 gap-6 px-4">
    {[
      ...
      <div key={i} className="relative group h-52 rounded-lg overflow-hidden shadow-lg hover:shadow-2xl transition-all duration-300">
        <Image src={image} alt={name} layout="fill" objectFit="cover" className="group-hover:scale-110 transition-transform duration-500" />
